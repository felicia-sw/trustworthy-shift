...
| `02_trade_off_audit.ipynb` | Four-property shift audit (predictive performance, calibration, group fairness, explanation stability) — do they degrade together or trade off? The paper's main descriptive contribution. | planned |
